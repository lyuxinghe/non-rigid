...
from non_rigid.models.dit.diffusion import create_diffusion_rigid
from non_rigid.models.dit.models import (
    TAX3Dv2_MuFrame_DiT,
    TAX3Dv2Rigid_FixedFrame_Token_DiT,
)
from non_rigid.utils.logging_utils import viz_predicted_vs_gt
from non_rigid.utils.pointcloud_utils import expand_pcd
from non_rigid.utils.transform_utils import update_rt_transformation, compute_transformed_pointcloud_from_diffusion
import rpad.visualize_3d.plots as vpl


def TAX3Dv2Rigid_FixedFrame_DiT_xS(**kwargs):
    return TAX3Dv2Rigid_FixedFrame_Token_DiT(depth=5, hidden_size=128, num_heads=4, **kwargs)

DiT_models = {
    "TAX3Dv2Rigid_FixedFrame_DiT_xS": TAX3Dv2Rigid_FixedFrame_DiT_xS,
}
...
def get_model(model_cfg):
    ...
    if model_cfg.frame_type == "fixed":
        model_name = "TAX3Dv2Rigid_FixedFrame_DiT_xS"
    else:
        raise ValueError("Choose model_take from [\"TAX3Dv2Rigid_FixedFrame_DiT_xS\"]")
    return DiT_models[model_name]


class TAX3Dv2RigidNetwork(nn.Module):
    """
...
class TAX3Dv2RigidBaseModule(L.LightningModule):
    ...
    def __init__(self, network, cfg) -> None:
        ...
        self.diffusion = create_diffusion_rigid(
        ...
        print("Initializing TAX3Dv2 Rigid Fixed-Frame Diffusion Transformer Network")
        ...
        print("Initializing TAX3Dv2 Rigid Fixed-Frame Dense Displacement Diffusion Module")
    ...
    def predict(self, batch, num_samples, unflatten=False, progress=True, full_prediction=True):
        ...
        pc_action_expanded = batch["pc_action"].clone()
        ...
        results = [compute_transformed_pointcloud_from_diffusion(pred_r=res["sample_r"], pred_s=res["sample_s"], pc_action=pc_action_expanded) for res in results]
...
class TAX3Dv2RigidFixedFrameModule(TAX3Dv2RigidBaseModule):
    """
