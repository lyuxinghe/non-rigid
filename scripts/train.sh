...
# ./train.sh 0 tax3dv2 online rpdiff model.pred_frame=noisy_goal model.noisy_goal_scale=1.0 model.object_scale=3.0 dataset.rpdiff_task_name=mug_rack_easy_single dataset.train_size=3200 dataset.val_size=400 dataset.test_size=400 training.batch_size=32 training.val_batch_size=16 resources.num_workers=32
### Mug_Rack_Med_Single ###
# ./train.sh 0 tax3dv2 online rpdiff model.pred_frame=noisy_goal model.noisy_goal_scale=1.0 model.object_scale=3.0 dataset.rpdiff_task_name=mug_rack_med_single dataset.train_size=1600 dataset.val_size=200 dataset.test_size=200 training.batch_size=16 training.val_batch_size=16 resources.num_workers=32
### Mug_Rack_Med_Multi ###
# ./train.sh 0 tax3dv2 online rpdiff model.pred_frame=noisy_goal model.noisy_goal_scale=1.0 model.object_scale=3.0 dataset.rpdiff_task_name=mug_rack_med_multi dataset.rpdiff_task_type=task_name_mug_on_rack_multi dataset.sample_size_anchor=1024 dataset.train_size=3200 dataset.val_size=400 dataset.test_size=400 training.batch_size=32 training.val_batch_size=16 resources.num_workers=32
### Mug_Rack_Hard_Multi ###
# ./train.sh 0 tax3dv2 online rpdiff model.pred_frame=noisy_goal model.noisy_goal_scale=1.0 model.object_scale=3.0 dataset.rpdiff_task_name=mug_on_rack_multi_large_proc_gen_demos dataset.rpdiff_task_type=task_name_mug_on_rack_multi dataset.sample_size_anchor=1024 dataset.train_size=3200 dataset.val_size=400 dataset.test_size=400 training.batch_size=32 training.val_batch_size=16 resources.num_workers=32
### Can_Cabinet ###
# ./train.sh 0 tax3dv2 online rpdiff model.pred_frame=noisy_goal model.noisy_goal_scale=1.0 model.object_scale=3.0 dataset.rpdiff_task_name=can_in_cabinet_stack dataset.rpdiff_task_type=task_name_stack_can_in_cabinet dataset.sample_size_anchor=1024 dataset.sample_size_action=256 dataset.train_size=3200 dataset.val_size=400 dataset.test_size=400 training.batch_size=32 training.val_batch_size=16 resources.num_workers=32
### Book_Bookshelf ###
# ./train.sh 0 tax3dv2 online rpdiff model.pred_frame=noisy_goal model.noisy_goal_scale=1.0 model.object_scale=3.0 dataset.rpdiff_task_name=book_on_bookshelf_double_view_rnd_ori dataset.rpdiff_task_type=task_name_book_in_bookshelf dataset.sample_size_anchor=1024 dataset.train_size=1600 dataset.val_size=200 dataset.test_size=200 training.batch_size=16 training.val_batch_size=16 resources.num_workers=32
...
if [ $MODEL_TYPE == "cross_flow" ]; then
  ...
  MODEL_PARAMS+=" model.one_hot_recon=False model.zero_shape=False"
