...
# Example usage:
#./train_gmm.sh 0 rpdiff dataset.rpdiff_task_name=mug_rack_med_multi dataset.rpdiff_task_type=task_name_mug_on_rack_multi dataset.train_size=3200 dataset.val_size=400 dataset.test_size=400 resources.num_workers=8
