...
# Anchor Centroid
# ./train_upgrade.sh 0 cross_point_relative rpdiff_fit online model.pred_ref_frame=anchor model.ref_error_scale=0.0
# ./train_upgrade.sh 0 cross_flow_relative rpdiff_fit online model.pred_ref_frame=anchor model.ref_error_scale=0.0
